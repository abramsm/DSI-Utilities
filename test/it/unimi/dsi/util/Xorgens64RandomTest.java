...
public class Xorgens64RandomTest {
	private final static long seeds[] = { 0, 1, 1024, 0x5555555555555555L };

//	@Test
//	public void testNextDouble() {
//		for ( long seed : seeds ) {
//			Xorgens64Random xorgens64Random = new Xorgens64Random( seed );
//			double avg = 0;
//			for ( int i = 1000000; i-- != 0; ) {
//				double d = xorgens64Random.nextDouble();
//				assertTrue( d < 1 );
//				assertTrue( d >= 0 );
//				avg += d;
//			}
...
//			double avg = 0;
//			for ( int i = 1000000; i-- != 0; ) {
//				float d = xorgens64Random.nextFloat();
//				assertTrue( d < 1 );
//				assertTrue( d >= 0 );
//				avg += d;
//			}
...
//				int d = xorgens64Random.nextInt( 101 );
//				assertTrue( d <= 100 );
//				assertTrue( d >= 0 );
//				avg += d;
//			}
