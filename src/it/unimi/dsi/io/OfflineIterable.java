...
public class OfflineIterable<T,U extends T> implements Iterable<U>, SafelyCloseable, Size64 {
	...
	public final static class OfflineIterator<A, B extends A> extends AbstractObjectIterator<B> implements SafelyCloseable {
		...
		private OfflineIterator( final DataInputStream dis, final Serializer<? super A, ? super B> serializer, final B store, final long size ) {
			this.dis = dis;
	 ...
	 * @throws IOException 
	 */
	public OfflineIterable( final Serializer<? super T, ? super U> serializer, final U store ) throws IOException {
		this.serializer = serializer;
		this.store = store;
