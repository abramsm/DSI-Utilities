...
public final class Fast {
	...
	private final static long MU0 = 0x5555555555555555L;  // MU0 == ((-1L)/3L) == ...01010101_2
	private final static long MU1 = 0x3333333333333333L;  // MU1 == ((-1L)/5L)   == ...00110011_2
	private final static long MU2 = 0x0f0f0f0f0f0f0f0fL;  // MU2 == ((-1L)/17L)  == ...00001111_2
	private final static long MU3 = 0x00ff00ff00ff00ffL;  // MU3 == ((-1L)/257L)  == (8 ones)
	private final static long MU4 = 0x0000ffff0000ffffL;  // MU4 == ((-1L)/65537L) == (16 ones)
	private final static long MU5 = 0x00000000ffffffffL;  // MU5 == ((-1L)/4294967297L) == (32 ones)

	private static int mostSignificantBit2( long x ) {
		return diffMsb(x, x & MU0)
		+ (diffMsb(x, x & MU1) << 1)
		+ (diffMsb(x, x & MU2) << 2)
		+ (diffMsb(x, x & MU3) << 3)
		+ (diffMsb(x, x & MU4) << 4)
	 ...
	 * @return the byte-reverse of <code>l</code>: the first byte is the last byte of <code>l</code>, and so on.
	 */
	...
	public static void main( final String a[] ) {
		...
		for( int k = 10; k-- !=0;  ) {
			...
			start = System.currentTimeMillis();
			for( long i = n, v = 0; i-- != 0; ) mostSignificantBit2( v += incr );
			elapsed = System.currentTimeMillis() - start;
